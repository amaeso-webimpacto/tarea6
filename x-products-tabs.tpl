    <div class="tabs product-tabs card card-block" >
        ...
        {*video a partir de "micampocustom"*}
        
         <iframe width="100%" height="315" src="{$product.micampocustom}"frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
